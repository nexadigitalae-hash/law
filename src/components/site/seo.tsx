...
// رابط ورابط الصورة الافتراضية للموقع
const SITE_URL = "https://alsalmi-law.com"; // قم بتعديل الدومين الخاص بك هنا إذا كان مختلفاً
...
export function buildHead({
  ...
  const meta: Array<Record<string, string>> = [
    ...
    { property: "og:site_name", content: "عبد الله السالمي للمحاماة والاستشارات القانونية" },
